...
export default function LoginPage(props: {server: string}) {
    ...
    return (
        <>
            <Header />
            <main className="w-screen h-screen flex justify-center bg-[#EBEBEB]">
                <div className="max-w-3xl p-6">
                    <form onSubmit={handleLoginFormSubmit} className="flex flex-col space-y-5">
                        ...
                        <input className="authInput focus:foucusedAuthInput"
                            type="text" placeholder="Име на профил" id="usernameInput" name="username" autoComplete="username" required />
                        ...
                        <hr />
                        <input className="border-ASLETThemeColor authInput focus:foucusedAuthInput"
